...
async function main() {
  ...
  const assignmentId = 8067667927;
  
  console.log('\n🔍 Checking assignment after update...\n');
  
  const assignment = await schoologyRequest(
    'GET',
  ...
  console.log('Category ID:', assignment.grading_category || assignment.category_id || 'NONE');
  console.log();
